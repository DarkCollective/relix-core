 ...
 */
/**
 * The engine-side machinery behind {@code com.darkcollective.relix.processor}: not exported by the published
 ...
 *   <li>{@link com.darkcollective.relix.processor.internal.ArrayRow} — the standard
 *       positional implementation of {@code Row}, backed by a fixed-size
 *       {@code Value[]} array.</li>
 *   <li>{@link com.darkcollective.relix.processor.internal.DataSourceConnector} — the
 *       functional interface that bridges external data sources (JDBC, HTTP)
 *       to the {@code Row} stream model.</li>
 *   <li>{@link com.darkcollective.relix.processor.internal.ExecutionContext} — the shared
