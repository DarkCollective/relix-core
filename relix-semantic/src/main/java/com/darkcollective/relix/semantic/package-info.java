 ...
 * orchestrated by {@link com.darkcollective.relix.semantic.SemanticAnalyzer} and
 * proceeds in five sequential phases:
 *
 * <ol>
 *   <li><b>Import Graph</b> ({@link com.darkcollective.relix.semantic.ImportGraph}) —
 *       resolves {@code import} statements depth-first and detects cycles.</li>
 *   <li><b>Symbol Collection</b> ({@link com.darkcollective.relix.semantic.SymbolCollector}) —
 *       registers every relation and function declared in all reachable scripts
 *       into an {@link com.darkcollective.relix.symbol.table.InMemorySymbolTable}.</li>
 *   <li><b>Schema Inference</b> ({@link com.darkcollective.relix.semantic.SchemaInferenceEngine}) —
 ...
 *   <li><b>Validation</b> ({@link com.darkcollective.relix.semantic.SemanticValidator}) —
 ...
 * <h2>Key classes</h2>
 * <dl>
 *   <dt>{@link com.darkcollective.relix.semantic.SemanticAnalyzer}</dt>
 *   <dd>Entry point; call {@code analyze(Script)} to run the full pipeline.</dd>
 *   <dt>{@link com.darkcollective.relix.semantic.SemanticResult}</dt>
 ...
 *   <dt>{@link com.darkcollective.relix.semantic.IrReport}</dt>
 ...
 *
 * @see com.darkcollective.relix.semantic.SemanticAnalyzer
 * @see com.darkcollective.relix.semantic.SemanticResult
