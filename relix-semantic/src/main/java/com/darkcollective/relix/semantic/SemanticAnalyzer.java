 ...
 * {@code FileSystemScriptLoader} and {@code ScriptText} in {@code relix-console}.
 *
...
public final class SemanticAnalyzer {
     ...
     * file system.  The text frontend ({@code ScriptText} in {@code relix-console})
     * uses it as the default root path.
     */
     ...
     * {@link com.darkcollective.relix.events.EventBuffer}, or any listener of its
