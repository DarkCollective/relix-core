...
import com.darkcollective.relix.semantic.json.SchemaJson;
...
public final class PhysicalPlanJson {
     ...
     * @param root   the physical plan root; must not be null
     */
    static void write(JsonWriter writer, PhysicalNode root) {
     ...
     * @param estimates the estimates recorded while planning; must not be null
     */
    static void write(JsonWriter writer, PhysicalNode root, PlanEstimates estimates) {
