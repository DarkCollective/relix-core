...
/**
 * A solver reachable through the real {@link java.util.ServiceLoader} path, so a
 * discovery test exercises discovery rather than a hand-built list.
 *
 ...
 */
public final class DiscoverableTestSolver implements MathProgrammingSolver {

    /** Required by {@link java.util.ServiceLoader}. */
    public DiscoverableTestSolver() {}

    @Override
    public String name() {
        return "discoverable-test-solver";
    }
