 ...
 */
/**
 * The engine-side machinery behind {@code com.darkcollective.relix.connectors.std}: not exported by the published
 * artifact. What follows describes the package as a whole, as it stood before the split.
 *
 * The standard library of {@link com.darkcollective.relix.processor.internal.DataSourceConnector}
 ...
 * <ul>
 *   <li>{@link com.darkcollective.relix.connectors.std.internal.CsvDataSourceConnector} —
 *       local CSV files declared with
 *       {@code source X from csv("path/to/file.csv") { … }};</li>
 *   <li>{@link com.darkcollective.relix.connectors.std.internal.JsonFileDataSourceConnector} —
 *       local JSON documents;</li>
 *   <li>{@link com.darkcollective.relix.connectors.std.internal.HttpDataSourceConnector} —
 *       read-only HTTP/JSON endpoints;</li>
 *   <li>{@link com.darkcollective.relix.connectors.std.internal.JdbcDataSourceConnector} —
 *       relational databases over JDBC, with
 *       {@link com.darkcollective.relix.connectors.std.internal.JdbcCatalogProvider} supplying
