...
/**
 * Set intersection (∩) — returns tuples that appear in both {@code left} and
 * {@code right}.
 *
 * <p>Example: {@code (A) ∩ (B)}
 *
 ...
 */
public record IntersectionNode(RelNode left, RelNode right, SourceLocation location) implements RelNode {
    ...
    public IntersectionNode(RelNode left, RelNode right) {
