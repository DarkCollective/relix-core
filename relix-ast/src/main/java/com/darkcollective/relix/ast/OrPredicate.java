...
/**
 * Logical disjunction (∨) — true when at least one of {@code left} or
 * {@code right} is true.
 *
 * <p>Example: {@code (age < 18) ∨ (role = "admin")}
 *
 ...
 */
public record OrPredicate(Predicate left, Predicate right, SourceLocation location) implements Predicate {
    public OrPredicate {
