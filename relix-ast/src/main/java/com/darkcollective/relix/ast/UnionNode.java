...
/**
 * Set union (∪) — returns tuples that appear in {@code left}, {@code right},
 * or both, eliminating duplicates.
 *
 * <p>Example: {@code (A) ∪ (B)}
 *
 ...
 */
public record UnionNode(RelNode left, RelNode right, SourceLocation location) implements RelNode {
    public UnionNode {
    ...
    public UnionNode(RelNode left, RelNode right) {
