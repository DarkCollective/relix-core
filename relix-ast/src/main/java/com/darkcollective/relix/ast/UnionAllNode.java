...
/**
 * Multiset union (⊎) — returns all tuples from both {@code left} and
 * {@code right}, preserving duplicates (equivalent to SQL {@code UNION ALL}).
 *
 * <p>Example: {@code (A) ⊎ (B)}
 *
 ...
 */
public record UnionAllNode(RelNode left, RelNode right, SourceLocation location) implements RelNode {
    public UnionAllNode {
    ...
    public UnionAllNode(RelNode left, RelNode right) {
