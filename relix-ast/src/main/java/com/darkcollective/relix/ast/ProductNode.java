...
/**
 * Cartesian product (×) — returns every combination of a tuple from {@code left}
 * with a tuple from {@code right}.
 *
 * <p>Example: {@code (A) × (B)}
 *
 ...
 */
public record ProductNode(RelNode left, RelNode right, SourceLocation location) implements RelNode {
    public ProductNode {
    ...
    public ProductNode(RelNode left, RelNode right) {
