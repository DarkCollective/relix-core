...
/**
 * Natural join (⋈) — joins two relations on all attributes with the same name,
 * projecting away the duplicate join columns.
 *
 * <p>Example: {@code (Users) ⋈ (Orders)}
 *
 ...
 */
public record NaturalJoinNode(RelNode left, RelNode right, SourceLocation location) implements RelNode {
    ...
    public NaturalJoinNode(RelNode left, RelNode right) {
